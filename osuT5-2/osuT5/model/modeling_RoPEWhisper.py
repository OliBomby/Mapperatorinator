...
class WhisperEncoder(WhisperPreTrainedModel):
    ...
    def __init__(self, config: WhisperConfig):
        ...
        self.gradient_checkpointing = True if config.gradient_checkpointing else False
    ...
    def forward(
        ...
        position_ids = torch.arange(inputs_embeds.size(1), device=inputs_embeds.device).unsqueeze(0).repeat(inputs_embeds.size(0), 1)
